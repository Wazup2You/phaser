...
function (_super) {
  ...
  LoadScene.prototype.loadImages = function () {
    this.load.setPath("./assets/image"); //@ts-ignore
  ...
  LoadScene.prototype.loadAudio = function () {
    this.load.setPath("./assets/audio"); //@ts-ignore
  ...
  LoadScene.prototype.loadSprites = function (frameConfig) {
    this.load.setPath("./assets/sprite"); //@ts-ignore
  ...
  LoadScene.prototype.preload = function () {
    ...
    this.loadImages(); // this.load.image("title_bg", "./assets/CLE4.png");
